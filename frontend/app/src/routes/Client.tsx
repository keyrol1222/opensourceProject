...
import CreateModal from '../components/ClientComponent/CreateModal'
import DeleteModal from '../components/ClientComponent/DeleteModal'
import Table from '../components/ClientComponent/Table'
...
setIsOpen(false)
      ...
      <header>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <h1 className="text-3xl font-bold leading-tight tracking-tight text-white">Clientes</h1>
            </div>
          </header>
        <Table
        OpenCreateModal={() => {
        ...
        cols={[
          'Identificador', 'Nombre', 'Email', 'Username'
        ]}
        />
        </div>
