    ...
    <header className="bg-gray-50 dark:bg-gray-900">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="/Id" className="text-sm font-semibold leading-6 text-white">
            Tipos
          </a>
          <a href="/Gender" className="text-sm font-semibold leading-6 text-white">
            Géneros
          </a>
          <a href="/Language" className="text-sm font-semibold leading-6 text-white">
          Idiomas
          </a>
