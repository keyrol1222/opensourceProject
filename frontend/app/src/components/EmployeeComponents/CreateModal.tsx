      ...
      <div className="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <div className="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Agregar Empleado</h3>
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4 mb-4 sm:grid-cols-2">
              ...
              <div>
                <label htmlFor="Username" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cédula</label>
              ...
              <div>
                <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanda labor</label>
              ...
              <div>
                <label htmlFor="Estado" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Porciento Comision</label>
